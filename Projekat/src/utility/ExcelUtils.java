...
public class ExcelUtils {
	...
	// Bilo koji podatak pretvaramo u string
	private static DataFormatter formatter;

	// Metoda koja nam postavlja excell fajl i poslato ime worksheeta
	public static void setExcelFile(String Path, String SheetName) throws Exception {
		try {
			// Ucitavamo neki fajl cija je putanja poslata kao Path
